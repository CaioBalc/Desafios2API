...
class Request{
    ...
    public function statusHttp($method){
...
class Controller{
    # DESAFIO NÚMERO 3
    public function queryPokémon($route){
        ...
        if (preg_match('/\/pokemon\/.+/', $route) ) {
            ...
            if (!file_exists("$searched.txt")) {
                ...
                $response = file_get_contents("https://pokeapi.co/api/v2/pokemon/$searched");
...
class Router{
    # DESAFIO NÚMERO 2
    public function pagePokémon($route){
